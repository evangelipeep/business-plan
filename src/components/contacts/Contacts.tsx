...
export const Contacts = () => {
  ...
  return (
    <>
        <section className='text-center mx-auto py-10'>
            <h1 className='text-xl pb-20'>Контакты</h1>
            <ul className='grid grid-cols-2 xl:grid-cols-4'>
                <li className={styleEl}>
                    <Telephone/>
                    <span className='font-bold'>Яна</span>
                    <a className='opacity-100 hover:opacity-50' href='tel:+79627118585'>+7 (962) 711-85-85</a>

                    <span className='font-bold'>Алиса</span>
                    <a className='opacity-100 hover:opacity-50' href='tel:+79673118585'>+7 (967) 311-85-85</a>
                ...
                <li className={styleEl}>
                    <Vk/>
                    <a className='opacity-100 hover:opacity-50 font-bold' href='https://vk.com/bus_plane_rus'>Группа ВК</a>
                </li>
                <li className={styleEl}>
                    <Telegram/>
                    <a className='opacity-100 hover:opacity-50 font-bold' href='https://t.me/biznesplansockontrakt'>Телеграмм</a>
                </li>
            </ul>
        </section>
    </>
